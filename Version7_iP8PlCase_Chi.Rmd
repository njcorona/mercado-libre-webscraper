...
write_csv(df, "6_6_iPh8PlCase_Raw_Chi_Prod.csv")
```
...
write_csv(seller_df, "6_6_iPh8PlCase_Raw_Chi_Sell.csv")
```
...
write_csv(df, "6_6_iPh8PlCase_Clean_Chi_Prod.csv")
write_csv(seller_df, "6_6_iPh8PlCase_Clean_Chi_Sell.csv")
...
write_csv(data_legend, "6_6_iPh8PlCase_Legend_Chi.csv")
```
