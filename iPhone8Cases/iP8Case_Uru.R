...
write_csv(df, date %>% paste("iPh8Case_Prod_Uru_Raw.csv", sep = ""))
...
write_csv(seller_df, date %>% paste("iPh8Case_Sell_Uru_Raw.csv", sep = ""))
...
write_csv(df, date %>% paste("iPh8Case_Prod_Uru.csv", sep = ""))
write_csv(seller_df, date %>% paste("iPh8Case_Sell_Uru.csv", sep = ""))
...
# write_csv(data_legend, "6_12_iPh8Case_Legend_Uru.csv")
