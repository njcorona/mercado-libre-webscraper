...
write_csv(df, date %>% paste("iPhone8Cases_Prod_Chi_Raw.csv", sep = ""))
...
write_csv(seller_df, date %>% paste("iPhone8Cases_Sell_Chi_Raw.csv", sep = ""))
...
write_csv(df, date %>% paste("iPhone8Cases_Prod_Chi.csv", sep = ""))
write_csv(seller_df, date %>% paste("iPhone8Cases_Sell_Chi.csv", sep = ""))
print(Sys.time())
