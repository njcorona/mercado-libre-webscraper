...
write_csv(df, date %>% paste("iPh8Case_Prod_Arg_Raw.csv", sep = ""))
...
write_csv(seller_df, date %>% paste("iPh8Case_Sell_Arg_Raw.csv", sep = ""))
...
write_csv(df, date %>% paste("iPh8Case_Prod_Arg.csv", sep = ""))
write_csv(seller_df, date %>% paste("iPh8Case_Sell_Arg.csv", sep = ""))
...
#write_csv(data_legend, "6_16_iPh8Case_Legend_Arg.csv")
