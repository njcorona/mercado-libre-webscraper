...
write_csv(df, date %>% paste("iPh8Case_Prod_Bra_Raw.csv", sep = ""))
...
write_csv(seller_df, date %>% paste("iPh8Case_Sell_Bra_Raw.csv", sep = ""))
...
write_csv(df, date %>% paste("iPh8Case_Prod_Bra.csv", sep = ""))
write_csv(seller_df, date %>% paste("iPh8Case_Sell_Bra.csv", sep = ""))
...
# write_csv(data_legend, "6_16_iPh8Case_Legend_Bra.csv")
