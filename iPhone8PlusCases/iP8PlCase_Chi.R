...
write_csv(df, date %>% paste("iPh8PlCase_Prod_Chi_Raw.csv", sep = ""))
...
write_csv(seller_df, date %>% paste("iPh8PlCase_Sell_Chi_Raw.csv", sep = ""))
...
write_csv(df, date %>% paste("iPh8PlCase_Prod_Chi.csv", sep = ""))
write_csv(seller_df, date %>% paste("iPh8PlCase_Sell_Chi.csv", sep = ""))
...
# write_csv(data_legend, "6_12_iPh8PlCase_Legend_Chi.csv")
