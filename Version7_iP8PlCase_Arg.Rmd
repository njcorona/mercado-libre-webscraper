...
write_csv(df, "6_11_iPh8PlCase_Raw_Arg_Prod.csv")
```
...
write_csv(seller_df, "6_11_iPh8PlCase_Raw_Arg_Sell.csv")
```
...
write_csv(df, "6_11_iPh8PlCase_Clean_Arg_Prod.csv")
write_csv(seller_df, "6_11_iPh8PlCase_Clean_Arg_Sell.csv")
...
write_csv(data_legend, "6_11_iPh8PlCase_Legend_Arg.csv")
```
