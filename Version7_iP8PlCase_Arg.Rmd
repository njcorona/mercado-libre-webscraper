...
write_csv(df, "6_6_iPh8PlCase_Prod_Raw_Arg.csv")
```
...
write_csv(seller_df, "6_6_iPh8PlCase_Sell_Raw_Arg.csv")
```
...
write_csv(df, "6_6_iPh8PlCase_Prod_Clean_Arg.csv")
write_csv(seller_df, "6_6_iPh8PlCase_Sell_Clean_Arg.csv")
...
write_csv(data_legend, "6_6_iPh8PlCase_Legend_Arg.csv")
```
