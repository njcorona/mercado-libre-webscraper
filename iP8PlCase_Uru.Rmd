...
write_csv(df, "iPh8PlCase_Prod_Raw_Uru.csv")
```
...
write_csv(seller_df, "iPh8PlCase_Sell_Raw_Uru.csv")
```
...
write_csv(df, "iPh8PlCase_Prod_Clean_Uru.csv")
write_csv(seller_df, "iPh8PlCase_Sell_Clean_Uru.csv")
...
write_csv(data_legend, "iPh8PlCase_Legend_Uru.csv")
```
