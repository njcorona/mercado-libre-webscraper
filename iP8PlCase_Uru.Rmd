...
write_csv(df, "6_11_iPh8PlCase_Raw_Uru_Prod.csv")
```
...
write_csv(seller_df, "6_11_iPh8PlCase_Raw_Uru_Sell.csv")
```
...
write_csv(df, "6_11_iPh8PlCase_Clean_Uru_Prod.csv")
write_csv(seller_df, "6_11_iPh8PlCase_Clean_Uru_Sell.csv")
...
write_csv(data_legend, "6_11_iPh8PlCase_Legend_Uru.csv")
```
