...
write_csv(df, "7_iPh8PlCase_Prod_Raw_Col.csv")
```
...
write_csv(seller_df, "7_iPh8PlCase_Sell_Raw_Col.csv")
```
...
write_csv(df, "7_iPh8PlCase_Prod_Clean_Col.csv")
write_csv(seller_df, "7_iPh8PlCase_Sell_Clean_Col.csv")
...
write_csv(data_legend, "7_iPh8PlCase_Legend_Col.csv")
```
