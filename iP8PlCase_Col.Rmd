...
write_csv(df, "6_11_iPh8PlCase_Raw_Col_Prod.csv")
```
...
write_csv(seller_df, "6_11_iPh8PlCase_Raw_Col_Sell.csv")
```
...
write_csv(df, "6_11_iPh8PlCase_Clean_Col_Prod.csv")
write_csv(seller_df, "6_11_iPh8PlCase_Clean_Col_Sell.csv")
...
write_csv(data_legend, "6_11_iPh8PlCase_Legend_Col.csv")
```
