...
write_csv(df, "6_8_iPh8PlCase_Raw_Mex_Prod.csv")
```
...
write_csv(seller_df, "6_7_iPh8PlCase_Raw_Mex_Sell.csv")
```
...
write_csv(df, "6_6_iPh8PlCase_Clean_Mex_Prod.csv")
write_csv(seller_df, "6_6_iPh8PlCase_Clean_Mex_Sell.csv")
...
write_csv(data_legend, "6_6_iPh8PlCase_Legend_Mex.csv")
```
