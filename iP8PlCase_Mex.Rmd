...
scrapeNodes <- function(test, search_position, name) {
  ...
  df1 <- tibble(search_position, name, list(char_categories), list(char_values), curr_price, orig_price, num_sold, in_stock, num_installments, arrival_time, shipping, free_return, free_return_info, review_avg, num_reviews, seller_link, product_link = test, five_star, four_star, three_star, two_star, one_star, item_id, amt_installments)
  return(df1)
}
```
...
write_csv(df, "6_12_iPh8PlCase_Raw_Mex_Prod.csv")
```
...
write_csv(seller_df, "6_12_iPh8PlCase_Raw_Mex_Sell.csv")
```
...
write_csv(df, "6_12_iPh8PlCase_Clean_Mex_Prod.csv")
write_csv(seller_df, "6_12_iPh8PlCase_Clean_Mex_Sell.csv")
...
write_csv(data_legend, "6_12_iPh8PlCase_Legend_Mex.csv")
```
