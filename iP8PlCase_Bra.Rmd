...
write_csv(df, "6_13_iPh8PlCase_Raw_Bra_Prod.csv")
```
...
write_csv(seller_df, "6_13_iPh8PlCase_Raw_Bra_Sell.csv")
```
...
write_csv(df, "6_13_iPh8PlCase_Clean_Bra_Prod.csv")
write_csv(seller_df, "6_13_iPh8PlCase_Clean_Bra_Sell.csv")
...
write_csv(data_legend, "6_13_iPh8PlCase_Legend_Bra.csv")
```
