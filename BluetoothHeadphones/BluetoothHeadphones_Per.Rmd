...
write_csv(df, date %>% paste("BlueoothHeadphones_Prod_Per_Raw.csv", sep = ""))
```
...
write_csv(seller_df, date %>% paste("BlueoothHeadphones_Sell_Per_Raw.csv", sep = ""))
```
...
write_csv(df, date %>% paste("BlueoothHeadphones_Prod_Per.csv", sep = ""))
write_csv(seller_df, date %>% paste("BlueoothHeadphones_Sell_Per.csv", sep = ""))
