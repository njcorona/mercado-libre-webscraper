...
write_csv(df, "iPh8PlCase_Prod_Raw_Per.csv")
```
...
write_csv(seller_df, "iPh8PlCase_Sell_Raw_Per.csv")
```
...
write_csv(df, "iPh8PlCase_Prod_Clean_Per.csv")
write_csv(seller_df, "iPh8PlCase_Sell_Clean_Per.csv")
...
write_csv(data_legend, "iPh8PlCase_Legend_Per.csv")
```
