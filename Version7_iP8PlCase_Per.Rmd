...
scrapeNodes <- function(test, search_position, name) {
  ...
  if (length(num_installments_alt) == 0) {
    num_installments_alt <- get_html_text(read_html, ".message-no-interest")
  }
...
write_csv(df, "7_iPh8PlCase_Prod_Raw_Per.csv")
```
...
write_csv(seller_df, "7_iPh8PlCase_Sell_Raw_Per.csv")
```
...
write_csv(df, "7_iPh8PlCase_Prod_Clean_Per.csv")
write_csv(seller_df, "7_iPh8PlCase_Sell_Clean_Per.csv")
...
write_csv(data_legend, "7_iPh8PlCase_Legend_Per.csv")
```
