...
#### Current file: BTHeadphones_Arg.R 

tryCatch({#' ---
#' title: "BluetoothHeadphones_Arg"
...
#' 
#' ### Links for bluetooth headphones, Argentina, including the first 50
#' 
## ----scrape_links--------------------------------------------------------
print(Sys.time())
...
url <- "https://listado.mercadolibre.com.ar/auriculares-bluetooth_ItemTypeID_N"
...
for (i in 1:num_products_to_scrape) {
  print(i)
  url <- paste(paste("https://listado.mercadolibre.com.ar/auriculares-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_ItemTypeID_N", sep = "")
  
  curr_url <- read_html(url) %>% html_nodes("a.item__info-title") %>% html_attr("href")
  
  curr_item <- read_html(paste(paste("https://listado.mercadolibre.com.ar/auriculares-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_ItemTypeID_N", sep = "")) %>% html_nodes(".main-title") %>% html_text()
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Arg_Raw.csv", sep = ""))
...
write_csv(seller_df, date %>% paste("BluetoothHeadphones_Sell_Arg_Raw.csv", sep = ""))
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Arg.csv", sep = ""))
write_csv(seller_df, date %>% paste("BluetoothHeadphones_Sell_Arg.csv", sep = ""))
...
#### Current file: BTHeadphones_Bra.R 
...
#' 
#' ### Links for bluetooth headphones, Brazil, including the first 50
#' 
## ----scrape_links--------------------------------------------------------
print(Sys.time())
date <- paste(str_sub(Sys.time(), 1, 10), "_", sep = "")
...
# The first URL when you search the products is different from the URLs for all products after the fiftieth.  That is the URL stored here.
url <- "https://lista.mercadolivre.com.br/bluetooth-fones-ouvido_ItemTypeID_N"
# read_html() is a function that takes in a URL and extracts the html code that is associated with that URL.
# html_nodes() is a function that takes in a block of html code and the name of a part of that code and returns that part of the html code, if it exists.
# html_text() takes in a part of an html code and returns any text data (words) associated with it. 
# html_attr() is similar to html_text() but it extracts any URL data associated with a node (like a hyperlink in an email).
...
for (i in 1:num_products_to_scrape) {
  print(i)
  url <- paste(paste("https://lista.mercadolivre.com.br/bluetooth-fones-ouvido_Desde_", (i * 50) + 1, sep = ""), "_DisplayType_LF_ItemTypeID_N", sep = "")
  
  curr_url <- read_html(url) %>% html_nodes("a.item__info-title") %>% html_attr("href")
  
  curr_item <- read_html(paste(paste("https://lista.mercadolivre.com.br/bluetooth-fones-ouvido_Desde_", (i * 50) + 1, sep = ""), "_DisplayType_LF_ItemTypeID_N", sep = "")) %>% html_nodes(".main-title") %>% html_text()
...
scrapeNodes <- function(test, search_position, name) {
  ...
  if (length(curr_price) == 2) {
   ...
   # Bra has periods to designate thousands.  Default interpretation is mistakenly that they're decimals, crops out trailing zeroes.
  curr_price <- str_replace(curr_price, "[\\.]", "")
  orig_price <- str_replace(orig_price, "[\\.]", "")
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Bra_Raw.csv", sep = ""))
...
for (i in 1:length(list_of_seller_links)) {
  ...
  if (length(get_html_text(read_html, ".ui-empty-state__title")) > 0) {
    if (get_html_text(read_html, ".ui-empty-state__title") == "¡Ups! hubo un error") { 
      print("break")
      break
    }
  }
...
# Extracts units in time_operating (either months or years).
# Note: this may run into an error if anything in the vector is NA.
seller_df$units_timeframe_of_amt_sold <- sapply(seller_df$timeframe_of_amt_sold, function(x) { if (is.na(x)) { return(x) } else { strsplit(x, " ")[[1]][5] } })
# seller_df$amt_sold <- sapply(seller_df$timeframe_of_amt_sold, function(x) { if (is.na(x)) { return(x) } else { strsplit(x, " ")[[1]][1] } })
seller_df$timeframe_of_amt_sold <- sapply(seller_df$timeframe_of_amt_sold, function(x) { if (is.na(x)) { return(x) } else { strsplit(x, " ")[[1]][6] } })

if (nrow(seller_df[which(seller_df$units_timeframe_of_amt_sold == "ano"),]) > 0) {
    seller_df[which(seller_df$units_timeframe_of_amt_sold == "ano"),]$timeframe_of_amt_sold <- "anos"
...
# If units are days, then the number of items sold in some timeframe is displayed in Spanish, so the unit is displayed differently than in Portuguese.
seller_df$timeframe_of_amt_sold[which(seller_df$units_of_time_operating == "dias")] <- "dias"
seller_df$units_timeframe_of_amt_sold[which(seller_df$units_of_time_operating == "dias")] <- seller_df$time_operating[which(seller_df$units_of_time_operating == "dias")]

write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Bra.csv", sep = ""))
...
#### Current file: BTHeadphones_Chi.R 

tryCatch({#' ---
#' title: "BluetoothHeadphones_Chi"
#' author: "NicolasCorona"
#' date: "6/2/2019"
#' output: html_document
#' ---
...
#' 
#' ### Links for bluetooth headphones, Chile, including the first 50
#' 
## ----scrape_links--------------------------------------------------------
print(Sys.time())
date <- paste(str_sub(Sys.time(), 1, 10), "_", sep = "")
...
# The first URL when you search the products is different from the URLs for all products after the fiftieth.  That is the URL stored here.
url <- "https://listado.mercadolibre.cl/audifonos-bluetooth_ItemTypeID_N"
# read_html() is a function that takes in a URL and extracts the html code that is associated with that URL.
# html_nodes() is a function that takes in a block of html code and the name of a part of that code and returns that part of the html code, if it exists.
# html_text() takes in a part of an html code and returns any text data (words) associated with it. 
# html_attr() is similar to html_text() but it extracts any URL data associated with a node (like a hyperlink in an email).
...
for (i in 1:num_products_to_scrape) {
  print(i)
  url <- paste(paste("https://listado.mercadolibre.cl/audifonos-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_ItemTypeID_N", sep = "")
  
  curr_url <- read_html(url) %>% html_nodes("a.item__info-title") %>% html_attr("href")
  
  curr_item <- read_html(paste(paste("https://listado.mercadolibre.cl/audifonos-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_ItemTypeID_N", sep = "")) %>% html_nodes(".main-title") %>% html_text()
...
scrapeNodes <- function(test, search_position, name) {
  ...
  # Usually NA for Chile.
  amt_installments <- get_html_text(read_html, ".free-installments .ch-price")
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Chi_Raw.csv", sep = ""))
...
seller_df <- bind_rows(list_of_dfs)
backup_seller_df <- seller_df
write_csv(seller_df, date %>% paste("BluetoothHeadphones_Sell_Chi_Raw.csv", sep = ""))
...
stored_installments <- df$num_installments
df$num_installments <- sapply(df$num_installments, function(x) { return((gsub("[\t\n$]", "", x) %>% str_extract_all("[0-9]*"))[[1]][1]) })
df$amt_installments <- sapply(df$amt_installments, function(x) {
  if (!is.na((gsub("[\t\n$]", "", x) %>% str_extract_all(".[0-9]*"))[[1]][2])) {
    return(paste((gsub("[\t\n$]", "", x) %>% str_extract_all("[0-9]*"))[[1]][2], (gsub("[\t\n$]", "", x) %>% str_extract_all(".[0-9]*"))[[1]][2], sep = ""))
  } else {
    return ((gsub("[\t\n$]", "", x) %>% str_extract_all("[0-9]*"))[[1]][2])
  }
 })
# df$amt_installments <- sapply(df$amt_installments, function(x) { return((gsub("[\t\n$]", "", x) %>% str_extract_all(".[0-9]*"))[[1]][2]) })
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Chi.csv", sep = ""))
write_csv(seller_df, date %>% paste("BluetoothHeadphones_Sell_Chi.csv", sep = ""))
...
#### Current file: BTHeadphones_Col.R 

tryCatch({#' ---
#' title: "BluetoothHeadphones_Col"
#' author: "NicolasCorona"
#' date: "6/4/2019"
#' output: html_document
#' ---
...
#' 
#' ### Links for bluetooth headphones, Colombia, including the first 50
#' 
## ----scrape_links--------------------------------------------------------
print(Sys.time())
date <- paste(str_sub(Sys.time(), 1, 10), "_", sep = "")
...
# The first URL when you search the products is different from the URLs for all products after the fiftieth.  That is the URL stored here.
url <- "https://listado.mercadolibre.com.co/audifonos-bluetooth_ItemTypeID_N"
# read_html() is a function that takes in a URL and extracts the html code that is associated with that URL.
# html_nodes() is a function that takes in a block of html code and the name of a part of that code and returns that part of the html code, if it exists.
# html_text() takes in a part of an html code and returns any text data (words) associated with it. 
# html_attr() is similar to html_text() but it extracts any URL data associated with a node (like a hyperlink in an email).
...
for (i in 1:num_products_to_scrape) {
  print(i)
  url <- paste(paste("https://listado.mercadolibre.com.co/audifonos-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_ItemTypeID_N", sep = "")
  
  curr_url <- read_html(url) %>% html_nodes("a.item__info-title") %>% html_attr("href")
  
  curr_item <- read_html(paste(paste("https://listado.mercadolibre.com.co/audifonos-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_ItemTypeID_N", sep = "")) %>% html_nodes(".main-title") %>% html_text()
...
scrapeNodes <- function(test, search_position, name) {
  ...
  if (length(in_stock) == 0) {
    ...
    if (length(in_stock) != 0) { # == may happen if item is put on "Publicacion pausada" status.
      if (gsub("[\t\n$]", "", in_stock) == "¡Único disponible!") {
        in_stock <- "1"
      }
      if (gsub("[\t\n$]", "", in_stock) == "¡Último disponible!") {
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Col_Raw.csv", sep = ""))
...
seller_df <- bind_rows(list_of_dfs)
backup_seller_df <- seller_df
write_csv(seller_df, date %>% paste("BluetoothHeadphones_Sell_Col_Raw.csv", sep = ""))
...
df$orig_price <- sapply(df$orig_price, function(x) {
  if (is.na(x)) { return(x) }
  if (str_count(x, "[\\.]") == 2) {
    return(str_replace(x, "[\\.]", ""))
  } else {
...
df$orig_price <- as.numeric(df$orig_price)

write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Col.csv", sep = ""))
write_csv(seller_df, date %>% paste("BluetoothHeadphones_Sell_Col.csv", sep = ""))
print(Sys.time())
...
#### Current file: BTHeadphones_Mex.R 

tryCatch({#' ---
#' title: "BluetoothHeadphones_Mex"
#' author: "NicolasCorona"
#' date: "6/8/2019"
#' output: html_document
#' ---
...
#' 
#' ### Links for bluetooth headphones, Mexico, including the first 50
#' 
## ----scrape_links--------------------------------------------------------
print(Sys.time())
date <- paste(str_sub(Sys.time(), 1, 10), "_", sep = "")
...
# The first URL when you search the products is different from the URLs for all products after the fiftieth.  That is the URL stored here.
url <- "https://listado.mercadolibre.com.mx/audifonos-bluetooth_DisplayType_LF_ITEM*CONDITION_2230284"
...
for (i in 1:num_products_to_scrape) {
  print(i)
  url <- paste(paste("https://listado.mercadolibre.com.mx/audifonos-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_DisplayType_LF_ITEM*CONDITION_2230284", sep = "")
  
  curr_url <- read_html(url) %>% html_nodes("a.item__info-title") %>% html_attr("href")
  
  curr_item <- read_html(paste(paste("https://listado.mercadolibre.com.mx/audifonos-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_DisplayType_LF_ITEM*CONDITION_2230284", sep = "")) %>% html_nodes(".main-title") %>% html_text()
...
list_of_dfs <- vector("list", 3000)
seq <- seq(1, length(links$curr_item.1.length.curr_url..) - 20, 20) # PUT BACK IN TO COMPLETE
# seq <- seq(1, 601, 20) # REMOVE TO COMPLETE
max <- seq[length(seq)] + 20  # PUT BACK IN TO COMPLETE
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Mex_Raw.csv", sep = ""))
...
list_of_seller_links <- list_of_seller_links[!duplicated(list_of_seller_links)]
# list_of_seller_links <- list_of_seller_links[!is.na(list_of_seller_links)]
# list_of_seller_links <- setdiff(list_of_seller_links, c("https://perfil.mercadolibre.com.mx/IBUMPER+VERACRUZ", "https://perfil.mercadolibre.com.mx/BENNY2711"))
list_of_dfs <- vector("list", 3000)
seller_df <- NULL
...
for (i in 1:length(list_of_seller_links)) {
  ...
  seller_name <- get_html_text(read_html, "#store-info__name")
  if (length(seller_name) == 0) {
    seller_name <- get_html_text(read_html, "h3 span")[[1]]
  }
  time_operating <- get_html_text(read_html, ".experience span span")
  units_of_time_operating <- get_html_text(read_html, ".experience > span")
  amt_sold <- get_html_text(read_html, ".seller-info__subtitle-sales span span:nth-child(1)")
...
seller_df <- bind_rows(list_of_dfs)
backup_seller_df <- seller_df
write_csv(seller_df, date %>% paste("BluetoothHeadphones_Sell_Mex_Raw.csv", sep = ""))
...
# Also applied to Uruguay.
stored_installments <- df$num_installments
df$num_installments <- sapply(df$num_installments, function(x) { return((gsub("[\t\n$]", "", x) %>% str_extract_all("[0-9]* meses"))[[1]][1]) })
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Mex.csv", sep = ""))
write_csv(seller_df, date %>% paste("BluetoothHeadphones_Sell_Mex.csv", sep = ""))
print(Sys.time())
...
#### Current file: BTHeadphones_Per.R 

tryCatch({#' ---
#' title: "BluetoothHeadphones_Per"
#' author: "NicolasCorona"
#' date: "5/27/2019"
#' output: html_document
#' ---
...
#' 
#' ### Links for bluetooth headphones, Peru, including the first 50
#' 
## ----scrape_links--------------------------------------------------------
print(Sys.time())
date <- paste(str_sub(Sys.time(), 1, 10), "_", sep = "")
...
# The first URL when you search the products is different from the URLs for all products after the fiftieth.  That is the URL stored here.
url <- "https://listado.mercadolibre.com.pe/audifonos-bluetooth_ItemTypeID_N"
# read_html() is a function that takes in a URL and extracts the html code that is associated with that URL.
# html_nodes() is a function that takes in a block of html code and the name of a part of that code and returns that part of the html code, if it exists.
# html_text() takes in a part of an html code and returns any text data (words) associated with it. 
# html_attr() is similar to html_text() but it extracts any URL data associated with a node (like a hyperlink in an email).
...
for (i in 1:num_products_to_scrape) {
  print(i)
  url <- paste(paste("https://listado.mercadolibre.com.pe/audifonos-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_ItemTypeID_N", sep = "")
  
  curr_url <- read_html(url) %>% html_nodes("a.item__info-title") %>% html_attr("href")
  
  curr_item <- read_html(paste(paste("https://listado.mercadolibre.com.pe/audifonos-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_ItemTypeID_N", sep = "")) %>% html_nodes(".main-title") %>% html_text()
...
scrapeNodes <- function(test, search_position, name) {
  ...
  if (length(curr_price) == 2) {
   ...
   # Per has periods to designate thousands.  Default interpretation is mistakenly that they're decimals, crops out trailing zeroes.
  curr_price <- str_replace(curr_price, "[\\.]", "")
  orig_price <- str_replace(orig_price, "[\\.]", "")
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Per_Raw.csv", sep = ""))
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Per.csv", sep = ""))
write_csv(seller_df, date %>% paste("BluetoothHeadphones_Sell_Per.csv", sep = ""))
...
#### Current file: BTHeadphones_Uru.R 

tryCatch({#' ---
#' title: "BluetoothHeadphones_Uru"
#' author: "NicolasCorona"
#' date: "6/6/2019"
#' output: html_document
#' ---
...
# The first URL when you search the products is different from the URLs for all products after the fiftieth.  That is the URL stored here.
url <- "https://listado.mercadolibre.com.uy/audifonos-bluetooth_ItemTypeID_N_NoIndex_True"
...
for (i in 1:num_products_to_scrape) {
  print(i)
  url <- paste(paste("https://listado.mercadolibre.com.uy/audifonos-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_ItemTypeID_N_NoIndex_True", sep = "")
  
  curr_url <- read_html(url) %>% html_nodes("a.item__info-title") %>% html_attr("href")
  
  curr_item <- read_html(paste(paste("https://listado.mercadolibre.com.uy/audifonos-bluetooth_Desde_", (i * 50) + 1, sep = ""), "_ItemTypeID_N_NoIndex_True", sep = "")) %>% html_nodes(".main-title") %>% html_text()
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Uru_Raw.csv", sep = ""))
...
seller_df <- bind_rows(list_of_dfs)
backup_seller_df <- seller_df
write_csv(seller_df, date %>% paste("BluetoothHeadphones_Sell_Uru_Raw.csv", sep = ""))
...
write_csv(df, date %>% paste("BluetoothHeadphones_Prod_Uru.csv", sep = ""))
write_csv(seller_df, date %>% paste("BluetoothHeadphones_Sell_Uru.csv", sep = ""))
